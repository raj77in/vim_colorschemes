" Vim color file
" Converted from Textmate theme Spectacular using Coloration v0.3.2 (http://github.com/sickill/coloration)
...
hi CursorLine ctermfg=NONE ctermbg=16 cterm=NONE guifg=NONE guibg=#222121 gui=NONE
hi CursorColumn ctermfg=NONE ctermbg=16 cterm=NONE guifg=NONE guibg=#222121 gui=NONE
hi ColorColumn ctermfg=NONE ctermbg=16 cterm=NONE guifg=NONE guibg=#222121 gui=NONE
hi LineNr ctermfg=244 ctermbg=16 cterm=NONE guifg=#7f7e7e guibg=#222121 gui=NONE
...
hi IncSearch ctermfg=NONE ctermbg=58 cterm=NONE guifg=NONE guibg=#5a3a1f gui=NONE
hi Search ctermfg=NONE ctermbg=58 cterm=NONE guifg=NONE guibg=#5a3a1f gui=NONE
...
hi NonText ctermfg=238 ctermbg=233 cterm=NONE guifg=#484848 guibg=#171616 gui=NONE
